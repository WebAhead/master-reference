...
- *Environment variables*: Why might some variables in your code need to change for different environments? Why is it a bad idea to include those variables in a public repository? What modules might you use to help manage environment variables? (checkout [dotenv](https://www.npmjs.com/package/dotenv)) If you can, write some sample code to show how it works.
